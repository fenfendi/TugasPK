...
<body data-spy="scroll" data-target="#navbarResponsive">
    ...
    <div id="home">
        ...
        <div id="slides" class="carousel slide" data-ride="carousel" data-interval="7000">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active" style="background-image:url(../assets/img/bg/background.jpeg);">
                    <div class="carousel-caption text-center">
                        <h1>Welcome To Black in the kumel Shop</h1>
                ...
                <div class="carousel-item" style="background-image:url(../assets/img/bg/background3.jpg);"></div>
    ...
    <div class="row jumbotron welcome">
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-10">
            <p class="lead">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perspiciatis, repellendus, illo et itaque a assumenda mollitia necessitatibus sapiente sunt quia rerum veritatis qui suscipit ea illum pariatur, harum totam nisi?</p>
        </div>
        <!-- </div> -->
            ...
            <div class="container mt-5">
                ...
                <div class="row">
                    <div class="col-md-12 text-center mt-2">
                        <p>
                            &copy;Copyright with Bootstrap 4 theme 2019
